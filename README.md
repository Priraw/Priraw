...
I'm an Analytics Engineer specializing in **data pipelines, ML deployment, and RAG systems**. 
...
### 💼 Looking For
Analytics Engineer or Data Engineer roles at companies solving meaningful problems with data.  
Based in Winnipeg, MB | Open to Toronto/Vancouver | Remote-friendly

### 🛠️ Tech Stack
```python
skills = {
    "languages": ["Python", "SQL", "JavaScript"],
    "data_engineering": ["PostgreSQL", "pandas", "ETL pipelines", "Data modeling"],
    "ml_ai": ["LangChain", "RAG", "Vector DBs", "XGBoost", "scikit-learn"],
    "deployment": ["FastAPI", "Streamlit", "Docker", "Render"],
    "analytics": ["Power BI", "DAX", "Statistical analysis"],
    "cloud": ["AWS (learning)", "S3", "RDS"]
}
```
